...
export class Migration1760478999586 implements MigrationInterface {
    name = 'Migration1760478999586'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "event" ("name", "total_seats") VALUES ('test_event', 10)`);
    }
